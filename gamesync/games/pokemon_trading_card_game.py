...
BINARY = os.path.join(os.path.expanduser('~'), '.vbam',
                      'Pokemon Trading Card Game.zip')
BINARY_STATUS = get_file_status(BINARY)
BINARY_TOKEN = 'binary.zip'
SAVE = os.path.join(os.path.expanduser('~'), '.vbam',
                    'Pokemon Trading Card Game.sav')
SAVE_STATUS = get_file_status(SAVE)
SAVE_TOKEN = 'savefile.sav'
TOKEN = 'pokemon_trading_card_game'
